    ...
    <>
      <div className="container" >
        ...
        <div className="text-container">
         ...
         <p className="title-text "> {userDetails.fullname}</p>
          <p className="info-text">{userDetails._id}</p>
          <p className="info-text">{userDetails.email}</p>
          <p className="desc-text">{userDetails.contactNumber}</p>
          <p className="desc-text">{userDetails.location}</p>
          <p className="desc-text">{userDetails.date}</p>
      ...
      <Link to="/">
      <i className="btn  bi bi-arrow-counterclockwise" style={{fontSize:"40px"}}></i>
            </Link> 
